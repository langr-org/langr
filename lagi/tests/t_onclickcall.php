<?php
/* $Id: t_onclickcall.php 15 2011-12-09 09:19:17Z loghua@gmail.com $ */
...
echo "<br/>3.0\n";var_dump($re);echo "\n";
//$re = channelAnalyse('808', $re['data']);
//echo "<br/>3.1\n";var_dump($re);echo "\n";
$re = lagi_command("show channels");
echo "<br/>3.2\n";var_dump($re);echo "\n";
//$re = channelAnalyse('SIP/808', $re['data']);
//echo "<br/>3.3\n";var_dump($re);echo "\n";
//$re = lagi_outcall('SIP/808', "808", '805');
//$re = lagi_originate('SIP/808', "805", 'clickcall <808>', 'from-internal', '1');
//$re = lagi_originate('SIP/808', "805", 'clickcall <808>');
echo "<br/>3\n";var_dump($re);echo "\n";
/*

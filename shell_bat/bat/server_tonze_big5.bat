...
choice /C yn /M "60秒鐘後開始啟動筒子伺服器,如果您認為準備好了請按'Y'跳過等待..." /T 60 /D y /N
...
echo 現在開始停止筒子伺服器,請您選擇下面的一種方式,或者等待10秒鐘後默認選擇'1'並繼續:
echo 	[1] 停止筒子伺服器, 備份資料庫, 並重新啟動系統
echo 	[2] 停止筒子伺服器, 備份資料庫
echo 	[3] 只需停止筒子伺服器
echo 	[n] 什麼都不做,直接退出

...
#		include_once(FILE_PATH."include/tools/ubbArticle.tool.php");
#		$Ubb = new Tool_Ubb;
#		$Ubb->ToolsImage = FILE_PATH."images/admin/ubbToolsButton2.gif";
#		$this->Tmpl['ubbTools'] = autoCharSet($Ubb->getUbbTools());	// 獲取 UBB 工具條
#
# 例2：UBB 代碼轉換
...
class Tool_Ubb
{
	...
	# 獲取 UBB 工具條的圖片和JS
	#=======================================================================================
	Function getUbbTools ()
	{
		$UbbTools = "
			<script>
			function addText(para){ // 增加包括表情符號在內的任何UBB代碼
				var para;
				var currentText = document.form1.content.value;
				document.form1.content.value=currentText + para;
			...
			<img src=\"".$this->ToolsImage."\"  height=\"22\" usemap=\"#Map\" border=\"0\"> 
			<map name=\"Map\"> 
				  <area shape=\"rect\" coords=\"-1,1,22,21\" onClick=bold() alt=\"粗體\"href=\"#bottom\">
				  ...
				  <area onClick=list() alt=插入編號 shape=\"rect\" coords=\"114,1,137,21\" href=\"#bottom\">
				  <area onClick=quote() alt=插入引用  shape=\"rect\" coords=\"137,0,160,21\" href=\"#bottom\">
				  <area onClick=image() alt=插入圖片 shape=\"rect\" coords=\"160,1,183,20\" href=\"#bottom\">

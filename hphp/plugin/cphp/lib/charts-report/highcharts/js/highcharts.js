//document.write("<script language='javascript' src='/test/dump/dump_src.js'></script>");
// ==ClosureCompiler==
					...
					.on('click', function(event) {
						var strLegendItemClick = 'legendItemClick',
							fnLegendItemClick = function() {
								/**
								 * add wtSelect 
								 * @modify by Langr <hua@langr.org> 2012/03/28 19:15 */
								//alert("ttt"+item.name+item.dselect);dump(itemOptions, null,1);
								if ( !itemOptions.wtSelect ) {
									return ;
								}
								item.setVisible();
							};

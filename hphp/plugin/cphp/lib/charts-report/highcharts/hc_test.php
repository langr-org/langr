 ...
 * 		)
 */
function show_report($data = array())
{
	;
}
 ...
 * 		)
 */
function ajax_show_report($data = array())
{
	;
}
?>
			$(document).ready(function() {
				chart = new Highcharts.Chart({
					...
					series: [{
						...
						name: '804(帅二)',
						data: [3.9, 4.2, 5.7, 8.5, 11.9, 15.2, 17.0, 16.6, 12, 10, 6.6, 4.8]
					}, {
						name: '604(帅二)',
						data: [4, 4.2, 5.7, 8.5, 11.9, 15.2, 17.0, 16.6, 14.2, 13, 6.6, 4.8]
					}, {
						name: '605(帅二)',
						data: [9, 4.2, 5.7, 8, 11.9, 15.2, 17.0, 16.6, 14.2, 10.3, 46, 4.8]
					}]
				});
			});
			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
					chart: {
						renderTo: 'container_line_t',
						zoomType: 'x',
						spacingRight: 20
					},
				    title: {
						text: '2011 年每天通话分钟数统计'
					},
				    subtitle: {
			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
					...
					xAxis: {
						categories: ['901(Apples)', '902(Oranges)', '903(Pears)', '904(Grapes)', '905(Bananas)']
					},
					yAxis: {
						min: 0,
						title: {
	...
	<body>
		<div id="container_line" style="width: 800px; height: 400px; margin: 0 auto"></div>
		<div id="container_line_t" style="width: 800px; height: 400px; margin: 0 auto"></div>
		<div id="container_column" style="width: 800px; height: 400px; margin: 0 auto"></div>
		<div id="container_column_2" style="width: 800px; height: 400px; margin: 0 auto"></div>
		<div id="container_area" style="width: 800px; height: 400px; margin: 0 auto"></div>
